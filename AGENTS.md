...
These instructions apply to the entire `abdulbasit742/cursor` repository. More specific AGENTS.md or AGENTS.override.md files in subdirectories may refine them.

Project: **AI Code Editor**.

Detected root stack: **Next.js / React / TypeScript**.
...
- Health/medical scope: preserve research-only and non-diagnostic wording, avoid unsupported clinical claims, protect patient data, and require domain-expert review for changes affecting predictions or advice.
